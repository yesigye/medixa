...
class Test extends MX_Controller {
	...
	function __construct() 
    {
		...
		$this->load->database();
		$this->load->library(array('unit_test', 'ion_auth'));
	...
	{
		$this->unit->run($this->user->all([]), 'is_array', 'Get all users in the database', '');
		$this->unit->run($this->user->all(['group' => 'adoctors']), 'is_array', 'Get all users in "doctors" group', '');
	}
