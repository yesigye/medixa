...
class Admin extends MX_Controller
{
	...
	/**
	 * View a list of users and perform some CRUD functions through AJAX
	 *
	 * @return response
	 **/
	...
	public function edit($user_id)
	{
		...
		$this->data['form_fields'] = [
			...
			'username' => [
				'label' => lang('form_users_username'),
			...
			'status' => [
				'label' => lang('form_users_status'),
				'help-text' => lang('form_users_status_txt'),
				'type' => 'checkbox',
				'value' => '1',
	...
	public function groups()
	{
		...
		$this->load->view('users/admin/groups/groups_list', $this->data);
	}
